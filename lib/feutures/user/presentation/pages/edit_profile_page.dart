...
import 'package:whats_app/feutures/user/presentation/widgets/profile/rowOf_changes_data_for%20_user.dart';
import 'package:whats_app/feutures/user/presentation/widgets/profile/stackOfImage.dart';
import 'package:whats_app/storage/storage_provider.dart';
import '../../../app/class/handle_image.dart';
...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  void submitProfileInfo() {
    ...
    if (service.file != null) {
      var storageUpload = Provider.of<StorageProviderRemoteDataSource>(
          context, listen: false);
      storageUpload.uploadProfileImage(
          file: service.file!,
