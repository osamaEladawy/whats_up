...
import 'package:whats_up/feutures/app/globel/data/data_formates.dart';
import 'package:whats_up/feutures/app/globel/widgets/profile_widget.dart';
import 'package:whats_up/feutures/app/globel/widgets/sigle_chate/show_image_and_video.dart';
import 'package:whats_up/feutures/status/domain/entities/status_entity.dart';
import 'package:whats_up/feutures/status/domain/entities/status_image_entity.dart';
import 'package:whats_up/feutures/status/domain/use_cases/get_my_status_future_usecase.dart';
import 'package:whats_up/feutures/status/presentation/manager/get_my_status/get_my_status_cubit.dart';
import 'package:whats_up/feutures/status/presentation/manager/status/status_cubit.dart';
import 'package:whats_up/feutures/status/presentation/widgets/status_dotted_borders_widget.dart';
import 'package:whats_up/feutures/theme/style.dart';
import 'package:whats_up/feutures/user/domain/entities/user_entity.dart';
...
class _StatusPageState extends State<StatusPage> {
  ...
  _uploadImageStatus(UserEntity currentUser) {
    var service = Provider.of<StorageProviderRemoteDataSource>(context,listen: false);
     service.uploadStatuses(
      ...
      sl<GetMyStatusFutureUseCase>().call(widget.currentUser.uid!).then((myStatus) {
