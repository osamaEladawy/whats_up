...
import 'package:whats_up/shared/widgets/dialogOfExit.dart';
            ...
            BlocBuilder<GetSingleUserCubit, GetSingleUserState>(
              builder: (context, state) {
                if (state is GetSingleUserLoaded) {
                  ...
                  return ListTile(
                    onTap: () {
                      context.pushNamed(PageConst.editProfilePage,
                          arguments: singleUser);
                    },
                    leading: singleUser.isOnline == true
                        ? Stack(
                            children: [
                              CircleAvatar(
                                radius: 25,
                                backgroundImage: service.profileImage(true,
                                    service.file, "${singleUser.profileUrl}"),
                              ),
                              Positioned(
                                bottom: 0,
                                right: 0,
                      ...
                      builder: (context) {
                        return DialogOfExit(
                          exit: () async {
                            ...
                            context
                                .pushNamedAndRemoveUntil(PageConst.welcomePage);
                          },
                        );
                      });
                },
